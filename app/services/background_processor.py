...
def background_data_consolidation(processor: BackgroundProcessor,
                                inventory_data: Dict,
                                building_data: Dict,
                                callback: Callable,
...
def background_data_filtering(processor: BackgroundProcessor,
                            data: List[Dict],
    ...
    return processor.submit_task(
        ...
        error_callback=error_callback,
        priority=2,
        task_name="data_filtering"
    )


def background_data_sorting(processor: BackgroundProcessor,
                          data: List[Dict],
                          sort_key: str,
                          reverse: bool,
                          callback: Callable,
